            ...
            <div class="card-gold">
                ...
                <form method="POST" action="{{ route('chefs.update',$chef->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="name" name="name" value="{{old('name',$chef->name)}}" class="form-control @error('name') is-invalid @enderror" >
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="role" name="role" value="{{old('role',$chef->role)}}" class="form-control @error('role') is-invalid @enderror" >
                        @error('role')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="info" name="info" rows="3" class="form-control @error('info') is-invalid @enderror" >{{old('info',$chef->info)}}</textarea>
                        @error('info')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
