            ...
            <div class="card-gold">
                ...
                <form method="POST" action="{{ route('items.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="price" name="price" rows="3" class="form-control @error('price') is-invalid @enderror" >{{old('price')}}</textarea>
                        @error('price')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
